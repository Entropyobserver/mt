...
#SBATCH -t 6:00:00
#SBATCH --array=0-26
#SBATCH -J exp2_gridsearch
#SBATCH -o logs/exp2-%A_%a.out
#SBATCH -e logs/exp2-%A_%a.err
...
export HF_DATASETS_CACHE=$HF_CACHE_DIR/cache_exp2_${SLURM_ARRAY_TASK_ID}
export TORCH_HOME=$HF_CACHE_DIR

cd "$PROJECT_ROOT" || exit 1
mkdir -p logs
python "$PROJECT_ROOT/experiments/en_no_expert/b_exp2.py" --job_id "$SLURM_ARRAY_TASK_ID"
