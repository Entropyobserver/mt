...
#SBATCH -t 48:00:00
#SBATCH -J final_eval_en_no
#SBATCH -o logs/final_eval_en_no_%j.out
#SBATCH -e logs/final_eval_en_no_%j.err
...
python "$PROJECT_ROOT/experiments/en_no_expert/d_final_eval.py"
